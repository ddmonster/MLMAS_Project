...
//info(current_frame:int, speed:float)
//ml_control(current_frame:int, throttle:float, steer:float , brake:float , hand_brake:bool, reverse:bool )

//f, sF, b, sB, l, r same as below
//f(current_frame:int, x:float, y:float, min_x, min_y)


//traffic_light(current_frame,typ,state,x,y,d,inBox)
//d: distance
...
//control(metricType:int,throttle:float, steer:float, brake:float, hand_brake:bool, reverse:bool, repeat:int)
